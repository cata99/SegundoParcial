...
INSERT INTO `STATE` (`ID`, `STATE`, `DESCRIPTION`) VALUES ('1', 'Stand-by','Descripcion_1');
INSERT INTO `STATE` (`ID`, `STATE`, `DESCRIPTION`) VALUES ('2', 'Done','Descripcion_2');
INSERT INTO `STATE` (`ID`, `STATE`, `DESCRIPTION`) VALUES ('3', 'Canceled','Descripcion_3');
INSERT INTO `STATE` (`ID`, `STATE`, `DESCRIPTION`) VALUES ('4', 'Opened','Descripcion_4');
INSERT INTO `STATE` (`ID`, `STATE`, `DESCRIPTION`) VALUES ('5', 'Re-opened','Descripcion_5');
